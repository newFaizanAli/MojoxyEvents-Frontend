...
import { SignInPage, ForgotPassword, PasswordOTPVerify, ResetPassword, UserSignUpPage, ArtistSignUpPage, } from "../pages/auth";
import { HomePage, CategoriesPage, ArtistsPage, ArtistProfile } from "../pages/public";
import {
    ArtistBooking, DashboardPage, UserPage, UsersList, ProfilePage, ArtistUpdateProfilePage,
...
const app_routes = [
                        ...
                        children: [
                            {
                                ...
                                children: [
                                    ...
                                    // artist
                                    { path: ROUTES_PATHS?.DASHBOARD?.ARTIST?.LIST, element: <ArtistsList /> },
                                    { path: ROUTES_PATHS?.DASHBOARD?.ARTIST?.BASE, element: <ArtistPage /> },
                                    // category
                                    { path: ROUTES_PATHS?.DASHBOARD?.CATEGORY?.LIST, element: <CategoriesList /> },
                                    { path: "category/:slug?", element: <CategoryPage /> },
                                    // package
                        ...
                        children: [
                            {
                                ...
                                children: [
                                    ...
                                    { path: ROUTES_PATHS?.DASHBOARD?.ARTIST?.PROFILE, element: <ArtistUpdateProfilePage /> },
                                ],
                            },
                        ],
                    },
...

    {
        ...
        children: [
            ...
            { path: ROUTES_PATHS?.AUTH.SIGNUP.USER, element: <UserSignUpPage /> },
            { path: ROUTES_PATHS?.AUTH.SIGNUP.ARTIST, element: <ArtistSignUpPage /> },
